        ...
        if (!collection.isEmpty())
        {
            ...
            for (PotionEffect potioneffect : this.mc.thePlayer.getActivePotionEffects())
            {
                ...
                if (potion.hasStatusIcon())
                {
                    ...
                    drawTexturedModalRect((pos.getExactPosX() + offsetX) - 20, (pos.getExactPosY() + i2) - offsetY, 0 + i1 % 8 * 18, 198 + i1 / 8 * 18, 18, 18);
                }
                ...
                font.drawString(s1, pos.getExactPosX() + offsetX, (pos.getExactPosY() + i2) - offsetY, 16777215, true);
                String s = Potion.getDurationString(potioneffect);
                font.drawString(s, pos.getExactPosX() + offsetX, (pos.getExactPosY() + i2 + 10) - offsetY, 8355711, true);
                i2 += l;
            }
        }
