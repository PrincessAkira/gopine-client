...
import net.gopine.modules.impl.ItemPhysicsModule;
...
public class RenderEntityItemMixin extends Render<EntityItem> {

    private final RenderItem itemRenderer;
    private Random field_177079_e = new Random();

    protected RenderEntityItemMixin(RenderManager renderManager, RenderItem itemRenderer) {
        super(renderManager);
    ...
    public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        int i = ItemPhysicsModule.shouldBeFlat ? this.renderItemWithPhysics(entity, x, y, z, partialTicks, ibakedmodel) : this.renderItem(entity, x, y, z, partialTicks, ibakedmodel);
